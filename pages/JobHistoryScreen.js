...
export default class JobHistoryScreen extends Component <Props> {
    static navigationOptions = {
    title: 'JobHistoryScreen',
    };
...
//                                                       });
        ...
        { /* Remove arrow function */
           ...
           const db = firebase.firestore();
            db.settings({ timestampsInSnapshots: true});
                    const query = db.collection('Jobs').where('assignedto', '==', currentUser).where('completed', '==', 'Y').limit(25);
